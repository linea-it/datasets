...
A compilation of reference redshifts produced using the pipeline [**Combine Redshift Catalogs (CRC)**](https://docs.linea.org.br/sci-platforms/pz_server_crc.html) by combining 38 catalogs with data from 51 surveys, mostly spectroscopic, to be matched to the LSST Object catalog to produce training and test sets for photo-z algorithms.
...
Generated by the **[Combine Redshift Catalogs (CRC)](https://docs.linea.org.br/sci-platforms/pz_server_crc.html)** pipeline of the **[Photo-z Server](https://docs.linea.org.br/sci-platforms/pz_server.html)**.
...
Generated by the **[Training Set Maker (TSM)](https://docs.linea.org.br/sci-platforms/pz_server_tsm.html)** pipeline of the **[Photo-z Server](https://docs.linea.org.br/sci-platforms/pz_server.html)**.
